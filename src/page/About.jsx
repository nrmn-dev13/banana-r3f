      ...
      >
        <div className="lg:w-3/4 mx-auto flex items-center flex-wrap lg:flex-nowrap border-2 rounded-xl p-5 border-[#ffd863] bg-[#ffd863]">
          ...
          <div>
            ...
            <br />
            <a className="rounded bg-[#ffd863] leading-4 py-1 px-2 border-[#000000] border-2 text-black transition-all hover:text-white hover:transition-all hover:bg-[#333333] hover:border-[#333333]" href="https://drive.google.com/file/d/1NunuqOvFdG2Q99UuTlT7FoIsiJXtNjDx/view?usp=sharing" target="_blank">Download CV</a>
          </div>
        </div>
      </m.section>
      {/* <m.section
